...
<body>
    ...
    <div class="page-container">
        ...
        <div class="report-header">
            <div class="report-title-badge">LAPORAN DATA INDUK PEGAWAI & MEDIS</div>
            <div class="report-meta-text" style="margin-top: 4px;">
                Filter Kategori: <strong><?php echo htmlspecialchars($filter_jabatan, ENT_QUOTES, 'UTF-8'); ?></strong>
            </div>
        </div>
        ...
        <div class="info-meta-box">
            ...
            <div>Total Personel: <strong><?php echo count($pegawai); ?> Orang</strong></div>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo htmlspecialchars($p->jenis_kelamin, ENT_QUOTES, 'UTF-8'); ?></td>
                    <td><span style="background: #e2e8f0; padding: 2px 8px; border-radius: 4px; font-size: 11px; font-weight: 600;"><?php echo htmlspecialchars($p->jabatan, ENT_QUOTES, 'UTF-8'); ?></span></td>
                    <td class="text-center"><?php echo $tgl_masuk; ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
