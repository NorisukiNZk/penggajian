...
">
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" name="bulan" id="inputBulan" required>
                ...
                <button style="width: 100%" type="submit" class="btn btn-primary"><i class="fas fa-print"></i> Cetak Rekapitulasi</button>
            </div>
        </form>
    </div>
</div>