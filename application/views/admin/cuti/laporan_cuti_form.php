...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold" style="letter-spacing: 1px;"><i class="fas fa-file-signature mr-2 text-primary"></i> <?php echo $title ?></h1>
    </div>
        ...
        <div class="col-lg-6 col-md-8 col-12">
            <div class="card shadow-lg mb-4" style="border-radius: 15px; border: none;">
                ...
                <div class="card-header py-4 bg-modern-blue d-flex flex-row align-items-center justify-content-between" style="border-radius: 15px 15px 0 0;">
                    <h6 class="m-0 font-weight-bold text-white"><i class="fas fa-filter mr-2"></i> Filter Laporan Cuti Pegawai</h6>
                </div>
                
                <!-- Card Body -->
                <div class="card-body p-4 bg-white" style="border-radius: 0 0 15px 15px;">
                    <form method="POST" action="<?php echo base_url('admin/laporan_cuti/cetak_laporan_cuti') ?>" target="_blank">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <small class="form-text text-muted mt-2"><i class="fas fa-info-circle mr-1"></i> Hanya menampilkan cuti yang berstatus <strong>Disetujui</strong>.</small>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary btn-lg btn-block mt-4" style="border-radius: 10px; font-weight: bold; letter-spacing: 1px; transition: all 0.3s; box-shadow: 0 4px 6px rgba(78, 115, 223, 0.2);">
                            <i class="fas fa-print mr-2"></i> Cetak Laporan Cuti
                        </button>
