        ...
        <div class="col-lg-6 col-md-8 col-12">
            <div class="card shadow-lg mb-4" style="border-radius: 15px; border: none;">
                ...
                <div class="card-header py-4 bg-modern-blue d-flex flex-row align-items-center justify-content-between" style="border-radius: 15px 15px 0 0;">
                    <h6 class="m-0 font-weight-bold text-white"><i class="fas fa-filter mr-2"></i> Filter Cetak Slip Gaji</h6>
                </div>
                
                <!-- Card Body -->
                <div class="card-body p-4 bg-white" style="border-radius: 0 0 15px 15px;">
                    <form method="POST" action="<?php echo base_url('admin/slip_gaji/cetak_slip_gaji') ?>" target="_blank">
                        ...
                        <div class="form-group mb-4">
                            <label class="font-weight-bold text-gray-800 mb-2">Nama Pegawai</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text bg-primary text-white border-0" style="border-radius: 10px 0 0 10px;"><i class="fas fa-user-circle"></i></span>
                                </div>
                                <select class="form-control form-control-lg bg-light border-0" name="nama_pegawai" required style="border-radius: 0 10px 10px 0; font-size: 0.95rem;">
