...
<head>
	...
	<style type="text/css">
		...
		h2 {
			margin: 0;
			padding: 5px;
			/* Mengurangi padding untuk mengurangi celah */
		}
		...
		h2 {
			font-size: 16px;
			/* Ukuran font lebih kecil untuk alamat */
			color: black;
			/* Warna hitam */
			font-weight: normal;
			/* Normal */
		...
		td {
			...
			/* Border hitam yang lebih tebal untuk tabel */
			padding: 10px;
			/* Padding untuk sel */
			text-align: left;
		}
...
<body>
	<div class="header">
		...
		<div class="report-title">DATA ABSENSI</div><!-- Judul untuk tabel pegawai -->
	</div>
	...
	<div>
		<strong>Bulan: </strong><?php echo $bulan; ?>
		<br>
