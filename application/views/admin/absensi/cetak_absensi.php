...
<head>
    ...
    <style type="text/css">
        * { box-sizing: border-box; }
        ...
        .kop-title { font-size: 19px; font-weight: 800; color: #0c2b4d; letter-spacing: 1.2px; text-transform: uppercase; margin: 0 0 2px 0; }
        .kop-subtitle { font-size: 11.5px; font-weight: 600; color: #0284c7; margin: 0 0 2px 0; }
        .kop-address { font-size: 10.5px; color: #475569; margin: 0; line-height: 1.4; }
        ...
        /* Tabel Data */
        table.data-table { width: 100%; border-collapse: collapse; margin-bottom: 25px; font-size: 11.5px; }
        table.data-table thead th { background-color: #0c2b4d; color: #ffffff; font-weight: 600; text-align: center; padding: 9px 8px; border: 1px solid #0c2b4d; font-size: 11px; letter-spacing: 0.2px; }
        table.data-table tbody td { border: 1px solid #cbd5e1; padding: 8px 8px; vertical-align: middle; color: #1e293b; }
        table.data-table tbody tr:nth-child(even) { background-color: #f8fafc; }
        table.data-table tbody td.text-center { text-align: center; }
        table.data-table tfoot td { background-color: #f1f5f9; border: 1px solid #94a3b8; font-weight: 700; padding: 8px; color: #0f172a; }

        .badge-kehadiran { display: inline-block; padding: 2px 8px; border-radius: 6px; font-weight: 700; font-size: 11px; }
        .badge-hadir { background: rgba(16, 185, 129, 0.15); color: #059669; }
        .badge-sakit { background: rgba(245, 158, 11, 0.15); color: #d97706; }
        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th width="18%">NIK</th>
                    <th>NAMA PEGAWAI</th>
                    <th width="14%">HADIR</th>
                    <th width="14%">SAKIT / IZIN</th>
            ...
            ?>
                <tr>
                    ...
                    <td class="text-center font-weight-bold"><?php echo htmlspecialchars($l->nik, ENT_QUOTES, 'UTF-8'); ?></td>
                    <td><strong><?php echo htmlspecialchars($l->nama_pegawai, ENT_QUOTES, 'UTF-8'); ?></strong></td>
                    <td class="text-center"><span class="badge-kehadiran badge-hadir"><?php echo $l->hadir; ?> Hari</span></td>
                    <td class="text-center"><span class="badge-kehadiran badge-sakit"><?php echo $l->sakit; ?> Hari</span></td>
                    <td class="text-center"><span class="badge-kehadiran badge-alpha"><?php echo $l->alpha; ?> Hari</span></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
            <tfoot>
                <tr>
                    <td colspan="3" class="text-center">AKUMULASI TOTAL HARI KERJA</td>
                    <td class="text-center font-weight-bold text-success"><?php echo $tot_hadir; ?> Hari</td>
                    <td class="text-center font-weight-bold text-warning"><?php echo $tot_sakit; ?> Hari</td>
                    <td class="text-center font-weight-bold text-danger"><?php echo $tot_alpha; ?> Hari</td>
                </tr>
            </tfoot>
        </table>
