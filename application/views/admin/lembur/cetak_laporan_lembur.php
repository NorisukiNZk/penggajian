...
<body>
    ...
    <div class="print-action-bar">
        <div>
            <span style="font-weight: 700; color: #0c2b4d; font-size: 14px;"><i class="fas fa-file-pdf text-danger mr-2"></i> Pratinjau Rekapitulasi Lembur Karyawan</span>
        </div>
    ...
    $noSurat = "Nomor : " . date('ymd') . "/LMBR-KPMH/" . $bulanRomawi[date('n')] . "/" . date('Y');
    ?>
    ...
    <div class="page-container">
        ...
        <div class="report-header">
            <div class="report-title-badge">LAPORAN REKAPITULASI LEMBUR KARYAWAN</div>
            <div class="report-meta-text">
                Periode: <strong><?php echo isset($bulanIndo[$bulan]) ? $bulanIndo[$bulan] : $bulan; ?> <?php echo $tahun; ?></strong>
            </div>
        </div>
        ...
        <div class="info-meta-box">
            ...
            <div>Dicetak pada: <strong><?php echo date('d') . ' ' . $bulanIndo[date('m')] . ' ' . date('Y') . ' ' . date('H:i') . ' WITA'; ?></strong></div>
        </div>
        ...
        <table class="data-table">
            <thead>
                <tr>
                    <th width="5%">No</th>
                    <th width="24%">Nama Karyawan</th>
                    <th width="14%">NIK</th>
                    <th width="13%">Tanggal</th>
                    <th width="18%">Waktu Pelaksanaan</th>
                    <th width="11%">Durasi (Jam)</th>
                    <th width="15%">Kompensasi (Rp)</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                ...
                <tr>
                    ...
                    <td class="text-center font-monospace" style="font-family: monospace;"><?php echo htmlspecialchars($l->nik, ENT_QUOTES, 'UTF-8'); ?></td>
                    <td class="text-center"><?php echo date('d/m/Y', strtotime($l->tanggal_lembur)); ?></td>
                    <td class="text-center"><?php echo date('H:i', strtotime($l->jam_mulai)); ?> - <?php echo date('H:i', strtotime($l->jam_selesai)); ?> WITA</td>
                    <td class="text-center font-weight-bold"><strong><?php echo $durasi; ?></strong></td>
                    <td class="text-right">Rp <?php echo number_format($uang, 0, ',', '.'); ?></td>
                </tr>
                <?php 
                    endforeach; 
                else :
                ...
                <tr>
                    <td colspan="7" class="text-center" style="padding: 25px; color: #64748b; font-style: italic;">
                        <i class="fas fa-info-circle mr-1"></i> Tidak ada data lembur yang disetujui pada periode bulan ini.
                    </td>
                </tr>
                <?php endif; ?>
            </tbody>
            ...
            <tfoot>
                <tr>
                    <td colspan="5" class="text-right">TOTAL REKAPITULASI LEMBUR :</td>
                    <td class="text-center" style="background: #e0f2fe; color: #0369a1;"><strong><?php echo $total_jam; ?> Jam</strong></td>
                    <td class="text-right" style="background: #ecfdf5; color: #047857; font-size: 12px;"><strong>Rp <?php echo number_format($total_uang, 0, ',', '.'); ?></strong></td>
                </tr>
            </tfoot>
            <?php endif; ?>
        </table>
        ...
        <div class="signature-section">
            <table class="signature-table">
                <tr>
                    <td>
                        <div class="signature-title">Mengetahui & Memverifikasi,</div>
